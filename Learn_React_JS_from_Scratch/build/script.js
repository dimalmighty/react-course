var Courses = React.createClass({
	...
	render: function () {
		return React.createElement(
			'span',
			{ className: 'content', 'data-fav-music': this.props.music },
			React.createElement(
				'p',
				null,
				'Hello ',
...
var Counter = React.createClass({
	...
	render: function () {
		...
		return React.createElement(
			...
			React.createElement(
				'button',
				{ style: this.state.buttonStyle, onClick: this.update },
				'update'
			)
		);
	}
...
var clickCounterElement = React.createElement(Counter, { count: 0 });
